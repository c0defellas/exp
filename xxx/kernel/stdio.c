/**
 * Printf adapted from Alexey Frunze
 * https://github.com/alexfru/SmallerC/blob/master/v0100/srclib/doprint.c
 */
...
void __fputc(char c, int lero, int lero2[2]) {
        termputchar(term, c);
}
...
int _doprintf(char* fmt, va_list vl)
{
        int f;
